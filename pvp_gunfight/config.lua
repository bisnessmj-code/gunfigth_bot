...
Config.Discord = {
    ...
    -- Si fourni, permet de récupérer les vrais avatars personnalisés
    -- Si vide, utilise les avatars par défaut Discord basés sur l'ID
    ...
    -- Avatar par défaut si pas de Discord lié
